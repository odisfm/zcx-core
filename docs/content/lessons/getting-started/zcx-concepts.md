...
The most common type of control you'll use is the [standard ZControl](../../reference/control/standard.md). There are also special subclasses of control that offer extra functionality, often in the LED feedback they provide.
