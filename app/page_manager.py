...
class PageManager(ZCXComponent):
    ...
    def set_page(self, page_number=None, page_name=None):
        ...
        if incoming_page_num < 0:
            incoming_page_num = self.__page_names.index(self.__page_names[page_number % len(self.__page_names)])
        elif incoming_page_num >= self.__page_count:
